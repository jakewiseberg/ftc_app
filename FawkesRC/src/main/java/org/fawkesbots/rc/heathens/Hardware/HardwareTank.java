...
public class HardwareTank extends Sentinel {
    ...
    public HardwareTank reverseSide(char side) {
        if(side=='l') {
            this.fl.setDirection(FawkesMotor.Direction.REVERSE);
            this.bl.setDirection(FawkesMotor.Direction.REVERSE);
        }
        if(side=='r') {
            this.fr.setDirection(FawkesMotor.Direction.REVERSE);
            this.br.setDirection(FawkesMotor.Direction.REVERSE);
        }
        return this;
    }
